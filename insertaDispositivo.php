...
<head>
  ...
  <title>INSERTAR DISPOSITIVO</title>
      ...
      <div class="row justify-content-center">
        <div class="col-12 col-md-8 col-lg-6">
          <form action="agregarDispositivobd.php" method="POST">
            ...
            <label for="direccion">Direccion Mac:</label>
            <input type="text" class="form-control" placeholder="Direccion Mac:" name="txtDireccionMac" required>
            </div>
            <div class="form-group">
